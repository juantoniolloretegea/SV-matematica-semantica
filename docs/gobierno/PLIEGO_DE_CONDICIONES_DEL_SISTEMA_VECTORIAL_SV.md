...
![Figura 1. Diagrama general del Pentateuco y criterio de prevalencia](figuras/figura_01_pentateuco_prevalencia.png)

*Figura 1. Diagrama general del Pentateuco y criterio de prevalencia.*

![Figura 2. Diagrama de jerarquía documental del Sistema Vectorial SV](figuras/figura_02_jerarquia_documental.png)
...
![Figura 14. Composición intercelular y parámetro puente](figuras/figura_14_compilador_celulas_parametro_puente.png)
...
![Figura 3. Diagrama del bloque compilador doctrinal y célula meta](figuras/figura_03_compilador_doctrinal_celula_meta.png)

*Figura 3. Diagrama del bloque compilador doctrinal y célula meta: doctrina, célula meta, reglas fuertes y cierre de fase.*

![Figura 4. Diagrama de continuidad entre compilador doctrinal, SV(9,3)-IA, IR/N4-Uso y publicaciones asociadas](figuras/figura_04_continuidad_compilador_ir_publicaciones.png)
...
![Figura 13. Célula SV y representación poligonal](figuras/figura_13_algebra_celula_poligonal.png)
...
![Figura 5. Diagrama del bloque algebraico-semántico](figuras/figura_05_bloque_algebraico_semantico.png)
...
![Figura 6. Diagrama de flujo del núcleo algebraico](figuras/figura_06_flujo_nucleo_algebraico.png)
...
![Figura 16. Interfaces: movilidad estructural y legitimidad de exposición](figuras/figura_16_interfaces_movilidad_frontera.png)
...
![Figura 7. Diagrama del Programa de interfaces](figuras/figura_07_programa_interfaces_frente_basico.png)

*Figura 7. Diagrama del Programa de interfaces: semántica, visión y motricidad como carriles del frente básico.*

![Figura 8. Diagrama del patrón de carril de interfaz](figuras/figura_08_patron_carril_interfaz.png)
...
![Figura 15. SVP Playground](figuras/figura_15_compilador_lenguaje_playground.png)
...
![Figura 9. Diagrama del bloque lenguaje](figuras/figura_09_bloque_lenguaje_flujo.png)

*Figura 9. Diagrama del bloque lenguaje: Playground → gramática → lowering → IR → validación → uso.*

![Figura 10. Diagrama de niveles N0–N4 del Lenguaje SV](figuras/figura_10_niveles_ir_n0_n4.png)
...
![Figura 11. Diagrama de estratos normativos de la Guía](figuras/figura_11_estratos_guia.png)

*Figura 11. Diagrama de estratos normativos de la Guía: reflexión, fundamentos, prospectiva, directrices y reglas inamovibles.*

![Figura 12. Diagrama de adopción prudencial del sistema y protocolo de actualización doctrinal](figuras/figura_12_adopcion_actualizacion.png)
