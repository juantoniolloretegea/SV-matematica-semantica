...
![Figura 1. Partición exhaustiva del espacio ternario de la célula meta SV(9,3)-IA en coordenadas (n₁, n_U). La figura no sustituye la partición algebraica: la hace visible.](../figuras/fig_01_sv93_particion_exhaustiva.png)
...
![Figura 2. Trayectorias estructurales ejemplares de U. La ordenación vertical 0, U, 1 se usa sólo para legibilidad y no introduce ordinalidad semántica.](../figuras/fig_02_trayectorias_u.png)
...
![Figura 3. Verificación geométrica auxiliar de la relación E_z = k(v)·h² para h=1. La figura refuerza la inteligibilidad; no constituye la semántica del sistema.](../figuras/fig_03_verificacion_geometrica_auxiliar.png)
...
![Figura 4. Régimen experimental de tres vallas: licitud doctrinal, código exacto y clausura con calidad. La figura sintetiza la disciplina de paso del programa experimental.](../figuras/fig_04_tres_vallas.png)
