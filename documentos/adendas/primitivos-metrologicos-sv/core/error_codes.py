...
"""Códigos de salida previstos para la suite laboratorial de primitivos metrológicos SV."""
...
DESCRIPTIONS = {
    ...
    ERR_SUPPORT_FILE_MISSING: "Falta un archivo estructural obligatorio del paquete.",
