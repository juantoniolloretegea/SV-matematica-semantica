...
<p align="center">
  <img src="imagenes/portada.png" alt="Representación visual de la articulación operativa entre las cuatro manifestaciones del aparato CHSH-SV — la cota Bell-local CHSH ≤ 2 sobre R₀, la sombra modular T(v; Q) ≡ 0 (mod 2) sobre 𝔽₂, el correlador angular factual acoplado C_SV(δ) = −cos δ del Teorema 10.2.1 y la saturación |S_SV| = 2√2 sobre R₂★ — y la ecuación rectora ℰ★_TODO,SV(Γ_U; τ) = 0 del nivel trece de la cadena ascendente del Sistema Vectorial SV." width="720"/>
</p>
