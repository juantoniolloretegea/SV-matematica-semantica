...
### 2. Diccionario formal de símbolos, dominios y funciones
...
### 3. Línea del Umbral SV como raíz del origen `O_U=(0,0)`
...
### 4. Radio estructural `R_U` como lectura radial desde `O_U=(0,0)`
...
### 5. Lanzadera Ómicron y tramo situado `Tierra → ∂Ωobs`
...
### 6. Contraste del radio estructural por cambio de origen
...
### 7. Cartas auxiliares radiales para objetos internos del Sistema Solar
...
### 8. Retornos externos calculados, cartas auxiliares radiales y control superior de compatibilidad
...
### 9. Criterio de elección de base de cálculo: Tierra, Sol, `O_U=(0,0)` y Lanzadera Ómicron
