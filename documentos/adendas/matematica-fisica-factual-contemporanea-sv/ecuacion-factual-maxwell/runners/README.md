...
Ejecuta el conjunto completo: veintiún bancos positivos, quince ataques negativos, escritura de resultados y control de no omisión. Abortará con salida distinta de cero ante cualquier banco ausente, error inesperado, falsación no detectada o pase silencioso.

## runner_rapido.py

Ejecuta el núcleo crítico: Gauss eléctrica, Faraday, Ampère–Maxwell, contornos tangenciales, reconfiguración, ecuación única, cosido dimensional soberano e identidad de onda factual.
