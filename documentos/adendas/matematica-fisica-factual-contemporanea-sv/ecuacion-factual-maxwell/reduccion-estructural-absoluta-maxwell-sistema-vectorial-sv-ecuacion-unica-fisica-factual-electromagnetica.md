...
En la ley de Gauss eléctrica factual, [Div<sub>SV</sub>(D)] = [D]/[UFE] = UFC · UE_MFC · UFE<sup>−3</sup> = [ρ].

En la ley de Gauss magnética factual, [Div<sub>SV</sub>(B)] = [B]/[UFE] = UFM · UFC<sup>−1</sup> · UE_MFC<sup>−2</sup> · UFE<sup>−1</sup>, y la compatibilidad con la anulación absoluta Div<sub>SV</sub>(B) = 0 se sostiene con dimensión inerte.

En la ley de Faraday factual, [Rot<sub>SV</sub>(E)] = [E]/[UFE] = UFM · UFC<sup>−1</sup> · UE_MFC<sup>−3</sup>, y [∂<sub>ν</sub><sup>SV</sup>B] = [B]/[UE_MFC] = UFM · UFC<sup>−1</sup> · UE_MFC<sup>−3</sup>. Ambas dimensiones coinciden exactamente.

En la ley de Ampère–Maxwell factual, [Rot<sub>SV</sub>(H)] = [H]/[UFE] = UFC · UFE<sup>−2</sup>, [∂<sub>ν</sub><sup>SV</sup>D] = [D]/[UE_MFC] = UFC · UFE<sup>−2</sup> y [J] = UFC · UFE<sup>−2</sup>. Triple coincidencia dimensional exacta.

En las relaciones constitutivas, [ε<sub>SV</sub>][E] = (UFC<sup>2</sup> · UE_MFC<sup>4</sup> · UFM<sup>−1</sup> · UFE<sup>−3</sup>) · (UFM · UFE · UFC<sup>−1</sup> · UE_MFC<sup>−3</sup>) = UFC · UE_MFC · UFE<sup>−2</sup> = [D]. Igualmente, [μ<sub>SV</sub>][H] = (UFM · UFE · UFC<sup>−2</sup> · UE_MFC<sup>−2</sup>) · (UFC · UFE<sup>−1</sup>) = UFM · UFC<sup>−1</sup> · UE_MFC<sup>−2</sup> = [B]. Y [σ<sub>SV</sub>][E] = (UFC<sup>2</sup> · UE_MFC<sup>3</sup> · UFM<sup>−1</sup> · UFE<sup>−3</sup>) · (UFM · UFE · UFC<sup>−1</sup> · UE_MFC<sup>−3</sup>) = UFC · UFE<sup>−2</sup> = [J].

En la identidad de conservación de la carga, [∂<sub>ν</sub><sup>SV</sup>ρ] = [ρ]/[UE_MFC] = UFC · UFE<sup>−3</sup>, y [Div<sub>SV</sub>(J)] = [J]/[UFE] = UFC · UFE<sup>−3</sup>.

En la identidad de balance electromagnético, [∂<sub>ν</sub><sup>SV</sup>u<sub>SV</sub>] = [u<sub>SV</sub>]/[UE_MFC] = UFM · UFE<sup>−1</sup> · UE_MFC<sup>−3</sup>, [Div<sub>SV</sub>(S<sub>SV</sub>)] = [S<sub>SV</sub>]/[UFE] = UFM · UFE<sup>−1</sup> · UE_MFC<sup>−3</sup> y [⟨E, J⟩<sub>SV</sub>] = [E][J] = UFM · UFE<sup>−1</sup> · UE_MFC<sup>−3</sup>. Triple coincidencia exacta.

Finalmente, en la identidad de onda factual, [Rot<sub>SV</sub>(Rot<sub>SV</sub>(E))] = [E]/[UFE<sup>2</sup>] y [ε<sub>SV</sub>μ<sub>SV</sub> ∂<sub>ν</sub><sup>SV,(2)</sup>E] = [ε<sub>SV</sub>μ<sub>SV</sub>][E]/[UE_MFC<sup>2</sup>]. Como [ε<sub>SV</sub>μ<sub>SV</sub>] = UE_MFC<sup>2</sup> · UFE<sup>−2</sup> = 1/[v<sub>SV</sub><sup>2</sup>], se obtiene coincidencia dimensional exacta.
