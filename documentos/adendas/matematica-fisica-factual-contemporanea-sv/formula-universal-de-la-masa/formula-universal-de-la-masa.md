...
Cada símbolo se define aquí una sola vez y con su valor exacto, de modo que el lector no necesite deducirlo ni buscarlo fuera del texto. Las magnitudes se expresan en unidades del Sistema Internacional salvo indicación contraria; las definiciones de la unidad astronómica y del año juliano siguen la convención de la Unión Astronómica Internacional (International Astronomical Union, 2012).
...
Las objeciones que cabe oponer a estos resultados se recogen de forma expresa, enfrentando cada una con su respuesta, para que el lector las juzgue sin buscarlas dispersas en el cuerpo del texto.
