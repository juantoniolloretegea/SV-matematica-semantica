...
- [0. Alcance, notación y fuentes](#sec-0)
- [I. Exposición física contemporánea de Λ, energía oscura y expansión](#sec-i)
  - [I.1. El problema canónico de la constante cosmológica](#sec-i-1)
  - [I.2. Aciertos y límites de ΛCDM como aparato físico](#sec-i-2)
- [II. Visión SV del mismo conjunto](#sec-ii)
- [III. Transductor universal Física Contemporánea ↔ SV](#sec-iii)
  - [III.1. Invariantes del transductor Λ-SV](#sec-iii-1)
  - [III.2. Residual del transductor](#sec-iii-2)
- [IV. Teorema de resolución física de la constante cosmológica](#sec-iv)
  - [IV.1. Constantes y magnitudes](#sec-iv-1)
  - [IV.2. Enunciado en dos niveles](#sec-iv-2)
- [V. Demostración](#sec-v)
  - [V.1. Derivación de κ<sub>obs</sub>](#sec-v-1)
  - [V.2. Derivación del coeficiente 3](#sec-v-2)
  - [V.3. Resolución de la discrepancia QFT-vacío frente a Λ retornada](#sec-v-3)
  - [V.4. Resolución del factor Ω<sub>Λ</sub>](#sec-v-4)
- [VI. Por qué comparece la constante cosmológica en SV](#sec-vi)
- [VII. Contraste numérico del porqué](#sec-vii)
  - [VII.1. Banco A — invariancia ciclo-distancial](#sec-vii-1)
  - [VII.2. Banco B — escalamiento cuadrático](#sec-vii-2)
  - [VII.3. Banco C — dominio puro frente a retorno físico](#sec-vii-3)
  - [VII.4. Banco D — coeficiente y alternativas erróneas](#sec-vii-4)
- [VIII. Banco adversarial de errores de concepto y cálculo](#sec-viii)
- [IX. Matriz de transducción y dictamen](#sec-ix)
- [X. Temperatura, dinámica de observables y retorno luminoso](#sec-x)
- [XI. Conclusión](#sec-xi)
