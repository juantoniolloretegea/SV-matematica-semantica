...
Autor: Juan Antonio Lloret Egea | ORCID: 0000-0002-6634-3351 | ITVIA | IA eñ™ — La Biblia de la IA™ | ISSN 2695-6411 | Licencia CC BY-NC-ND 4.0 | Madrid, 19/05/2026.
...
def imprimir(filas, fallos):
    print("=" * 80)
    print("  Autor: Juan Antonio Lloret Egea | ORCID: 0000-0002-6634-3351 | ITVIA | IA eñ™ — La Biblia de la IA™ | ISSN 2695-6411 | Licencia CC BY-NC-ND 4.0 | Madrid, 19/05/2026")
    print("  BATERÍA DE BANCOS NEGATIVOS - TRANSDUCTOR DE DISTANCIA SV↔FÍSICA")
    print("=" * 80)
    fmt = "{:<6} {:<9} {:<15} {:<9} {:<28} {:<6}"
    print(fmt.format("CASO", "TIPO", "ESPERADO", "OBTENIDO",
                     "COMPUERTA / CODIGO", "JUICIO"))
    print("-" * 80)
    for f in filas:
        print(fmt.format(*f))
    print("-" * 80)
