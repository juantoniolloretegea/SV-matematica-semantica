...
**Serie editorial:** IA eñ™ — La Biblia de la IA™  
**ISSN:** 2695-6411  
...
| Ruta | Función |
|:---|:---|
| `distancia-absoluta-relativa-observables-universo.md` | Desarrollo unificado con portada, resumen, abstract, índice en cascada, seis partes y bibliografía. |
...
El laboratorio debe aceptar 6/6 positivos, rechazar 15/15 negativos por la compuerta correspondiente y emitir el dictamen `BATERIA SUPERADA`.
