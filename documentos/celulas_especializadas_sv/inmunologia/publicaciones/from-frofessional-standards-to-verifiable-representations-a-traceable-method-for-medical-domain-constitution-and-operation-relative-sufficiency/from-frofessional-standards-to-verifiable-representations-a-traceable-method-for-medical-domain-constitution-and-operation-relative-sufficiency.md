...
> Aunque a lo largo del documento los términos [**IMMUNO-1**](https://juantoniolloretegea.github.io/SVperitus-dataset/aplicaciones/demo_wasm/index.html) [**IMMUNO-2**](https://juantoniolloretegea.github.io/SVperitus-dataset/aplicaciones/demo_wasm/compositor.html) se explican suficientemente, es recomendable una visualización previa en sus enlaces respectivos
