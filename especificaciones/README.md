...
## Estructura activa de esta carpeta

En el estado actual, `especificaciones/` se organiza en tres planos internos diferenciados:

- [`nucleo/`](./nucleo/) → piezas transversales subordinadas ya consolidadas;
- [`proposiciones/`](./proposiciones/) → proposiciones de trabajo y matrices operativas de alcance metodológico;
- [`laboratorio/`](./laboratorio/) → textos de exploración formal alojados de forma expresa sin adquisición automática de rango canónico.

Esta diferenciación interna no altera la jerarquía del sistema: ordena materiales subordinados con distinto grado de consolidación.
...
En el plano `proposiciones/` consta actualmente:

- [`proposiciones/matriz_operativa_completa_clasificador_sv.md`](./proposiciones/matriz_operativa_completa_clasificador_sv.md)
...
En el plano `laboratorio/` consta actualmente:

- [`laboratorio/desde_la_terna_0_1_u_hasta_la_nueva_frontera_0_1_u_0_1.md`](./laboratorio/desde_la_terna_0_1_u_hasta_la_nueva_frontera_0_1_u_0_1.md)
...
En particular, la existencia de piezas en espejo dentro del repositorio `SV-lenguaje-de-computacion` no altera esta prioridad: allí pueden existir rutas de trabajo, vigilancia o laboratorio, pero la autoridad doctrinal sigue residiendo aquí y en la publicación canónica.
...
Carpeta activada con núcleo doctrinal subordinado, plano de proposiciones de trabajo y plano de laboratorio experimental alojados bajo control jerárquico.
