...
La U nace en el Sistema Vectorial SV no como residuo, error ni degradación, sino como **garantía formal de honestidad cognoscitiva**. Su origen doctrinal es inseparable de una decisión axial del marco: el sistema no puede cerrar como cierto aquello que no está suficientemente determinado.
...
De conformidad con la guía, los **documentos** del proyecto se publican en `itvia.online (PubPub)`, mientras que el **código**, los **datos asociados** y los **artefactos técnicos de soporte** se alojan en GitHub. Por ello, no debe afirmarse que “el documento está en el repositorio”; debe afirmarse, en su caso, que existen **artefactos asociados** o **reflejos técnicos** en los repositorios correspondientes.

### 16.2. Carpetas de referencia previstas en el ecosistema de repositorios

Tras su publicación canónica, el presente documento podrá tener reflejo o derivación en las siguientes carpetas del ecosistema SV:

| Función | Repositorio | Carpeta |
|---|---|---|
| Reflejo doctrinal principal | `SV-matematica-semantica` | `especificaciones/` |
| Derivación técnica del lenguaje | `SV-lenguaje-de-computacion` | `spec/` |
| Nota puente de aplicación a SVperitus | `SVperitus-dataset` | `especificaciones/nucleo/` |

Estos reflejos no sustituyen la publicación canónica ni alteran la jerarquía doctrinal del sistema.
...
- mantiene la distinción entre publicación documental y artefactos técnicos asociados;
